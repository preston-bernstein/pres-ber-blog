...
- [What a $364 Claude Code session taught me about running agents unattended](/blog/what-a-364-dollar-claude-code-session-taught-me-about-agent-hygiene/)
- [Three failure modes wearing one name: running concurrent Claude Code agents](/blog/three-failure-modes-one-name-concurrent-claude-code-agents/)
- [Tuning LightRAG ingestion concurrency against a rate-limited Gemini API](/blog/tuning-lightrag-ingestion-concurrency-against-gemini-rate-limits/)
- [Not every Docker container belongs on the NAS](/blog/not-every-docker-container-belongs-on-the-nas/)

You can read more [about me](/about/), browse the [blog](/blog/), see my projects on [GitHub](https://github.com/preston-bernstein/), or connect on [LinkedIn](https://www.linkedin.com/in/prestonbernstein/).
